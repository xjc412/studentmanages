...
<ul>
    <li><a href="CourseServlet" target="rightframe">查看所有课程</a></li>
    <li><a href="./insertCourse.jsp" target="rightframe">新增课程信息</a></li>
    <li><a href="./deleteCourse.jsp" target="rightframe">删除课程信息</a></li>
    <li><a href="./updateCourse.jsp" target="rightframe">修改课程信息</a></li>
